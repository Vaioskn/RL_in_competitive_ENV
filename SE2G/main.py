import pygame
import os
from settings import window_width, window_height, white, MAX_EPSILON_Q, MAX_EPSILON_MIN_MAX, EPISODES_FOR_QUITING_PROGRAM, INFINITE_EPISODES, MAX_ALPHA
...
def main():
    ...
    player_q_agent.load_q_table('small_env_2_player_q_table.json')
    agent_q_agent.load_q_table('small_env_2_agent_q_table.json')

    # if ENABLE_MINIMAX_Q_LEARNING_TRAINING:
    agent_minimax_agent.load_tables('small_env_2_agent_minimax_q_table.json', 'small_env_2_agent_minimax_pi_table.json', 'small_env_2_agent_minimax_v_table.json')
    # if ENABLE_BELIEF_Q_LEARNING_TRAINING:
    agent_belief_agent.load_tables('small_env_2_agent_belief_q_table.json', 'small_env_2_agent_belief_v_table.json', 'small_env_2_agent_belief_table.json')
    ...
    while running:
        ...
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                ...
                #     player_q_agent.save_q_table('small_env_2_player_q_table.json')
                #     agent_q_agent.save_q_table('small_env_2_agent_q_table.json')
                # if ENABLE_MINIMAX_Q_LEARNING_TRAINING:
                #     agent_minimax_agent.save_tables('small_env_2_agent_minimax_q_table.json', 'small_env_2_agent_minimax_pi_table.json', 'small_env_2_agent_minimax_v_table.json')
                # if ENABLE_BELIEF_Q_LEARNING_TRAINING:
                #     agent_belief_agent.save_tables('small_env_2_agent_belief_q_table.json', 'small_env_2_agent_belief_v_table.json', 'small_env_2_agent_belief_table.json')
                running = False
        ...
        #         if after_loop_state_for_logging_1["ball_position"] in [(6,2)]:
        #             agent_reward += 100
        #         elif after_loop_state_for_logging_1["ball_position"] in [(0,2)]:
        #             agent_reward -= 100
